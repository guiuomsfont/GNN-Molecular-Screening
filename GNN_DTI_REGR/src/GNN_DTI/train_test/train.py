...
def train_gnn():
    ...
    # Define the loss function for linear regressions.
    # It can be MSE, MAE or HINGE
    loss_fn = nn.MSELoss()
    ...
    for epoch in range(num_epochs):
        ...
        epoch_results = (
            ...
            + " "
            + str(round(MSE_train, 3))
            + " "
            + str(round(MAE_train, 3))
            + " "
            + str(round(MSE_test, 3))
            + " "
            + str(round(MAE_test, 3))
            + " "
            + str(end - st)
            + "\n"
        )
